...
$(".organization").css("color", ptitlecolor);
$(".organization").css("font-size", ptitlefontsize);
$(".organization").css("font-weight", ptitleweight);
$(".organization").css("text-decoration", ptitledecoration);
$(".organization").css("font-style", ptitlestyle);

$(".role").css("color", selfcolor);
$(".role").css("font-weight", selfweight);
$(".role").css("text-decoration", selfdecoration);
$(".role").css("font-style", selfstyle);